...
object LibIcon {
    ...
    val ArrowPyramidUp = R.drawable.ic_arrow_pyramid_up
    val ArrowPyramidDown = R.drawable.ic_arrow_pyramid_down
    val ArrowBackAndUp = R.drawable.ic_arrow_back_and_up
    val Postpone = R.drawable.ic_postpone
